    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ url('emploiExamens/create') }}" class="btn btn-primary float-right">Ajouter</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ url('edit-emploiExamenStudent/'.$emploi->id) }}" class="btn btn-link btn-warning btn-just-icon edit btn-sm"><i class="fas fa-pencil-alt"></i></a>
                        </td>
                        <td class="text-center">
                            <form action="{{ url('delete-emploiExamenStudent/'.$emploi->id) }}" onsubmit="return confirm('Are you sure to delete this data?')">
