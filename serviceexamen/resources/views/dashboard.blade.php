          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  <h3>{{ $studentDemandeTypeStatut }}/{{ $studentDemandeType }}</h3>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3>{{ $emploisExamenStudents }}</h3>
  
                  <p>Examens étudiants </p>
                </div>
                <div class="icon">
                  <i class="ion ion-stats-bars"></i>
                </div>
                <a href="{{url('emploiExamens')}}" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  ...
                  <p>Surveillance des enseignants</p>
                </div>
                <div class="icon">
                  <i class="ion ion-pie-graph"></i>
                </div>
                <a href="{{url('emploiSurveillances')}}" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
