    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ url('avisTeacher') }}">Liste des avis</a></li>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>
                        <a href="{{ url('avisTeacher') }}" class="btn btn-danger float-right">Retour</a>
                    </h4>
                </div>

                <div class="card-body">
                  @foreach ($avis as $avisElement)
                  <form action="{{ url('update-avisTeacher/'.$avisElement->id) }}" enctype="multipart/form-data">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-4">
                            ...
                            <select name="departement" class="form-control">
                                <option value="{{ $avisElement->departement }}">{{ $avisElement->departement }}</option>
                                <option value="" disabled>-------------------------</option>
                                <option value="Design">Design</option>
                                <option value="Musique et Musicologie">Musique et Musicologie</option>
                            </select>
                        </div>
                          <div class="col-md-4">
                              <label for="">Type</label>
                              <input type="text" name="type" value="{{ $avisElement->type }}" class="form-control" readonly>
                          </div>
                      </div>
                      {{-- <br><hr><br> --}}
                  ...
                  <div class="row">
                    <div class="col-md-5">
                        <form action="{{ url('update-photoAvisTeacher/'.$avisElement->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de modifier ces données?')" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                    ...
                    <div class="col-md-5">
                        <form action="{{ url('update-photoPdfTeacher/'.$avisElement->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de modifier ces données?')" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-input-steps" style="text-align: left;">
                                <div class="row">
