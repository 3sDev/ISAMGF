                      ...
                      <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                {{-- @if (($item->email!='')) --}}
                                  <a href="{{ url('teachers/'.$item->id.'/profile') }}" class="btn btn-link btn-warning btn-just-icon edit"><i class="nav-icon fas fa-user"></i></a>
                                {{-- @endif --}}
                                {{-- @if (($item->email==''))
                              ...
                              <td>
                                <form action="{{ url('teachers/'.$item->id) }}" method="POST" onsubmit="return confirm('Are you sure to delete this data?')">
                                  @csrf
                                  @method('DELETE')
