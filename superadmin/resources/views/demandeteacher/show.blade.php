                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <span>Mr (me) : </span> <label>{{ $demand->teacher->nom.' '.$demand->teacher->prenom  }}</label><br>
                                            <span>Né(e) le : </span> <label>{{ $demand->teacher->ddn }}</label> à <label>{{ $demand->teacher->gov }}</label><br>
                                            <span>Nationalité : </span> <label>{{ $demand->teacher->nationnalite }}</label><br>
                                    ...
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        ...
                                        <table style="width: 100%; direction: rtl">
                                            ...
                                            <tr>
                                                ...
                                                <td><label>{{ $demand->teacher->ddn }}</label></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><label>{{ $demand->teacher->poste }}</label></td>
                                            </tr>
                                        </table>
                                        <br>
                                    ...
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        <table style="width: 100%; direction: rtl">
                                            ...
                                            <tr>
                                                ...
                                                <td width="64%"><label>{{ $demand->teacher->ddn.'-'.$demand->teacher->gov }}</label></td>
                                            </tr>
                                            {{-- <tr>
                                                <td><span>رتبته أو صنفه</span><span style="float: left; margin-left: 20%;">:</span> </td>
                                                <td><label>{{ $demand->teacher->grade }}</label></td>
