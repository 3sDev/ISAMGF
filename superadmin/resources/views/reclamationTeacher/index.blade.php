                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <td>{{ $reclam->teacher->prenom.' '.$reclam->teacher->nom }}</td>
                            <td>{{ $reclam->teacher->tel1_teacher }}</td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ url('edit-reclamationTeacher/'.$reclam->id) }}" class="btn btn-link btn-success btn-just-icon edit btn-sm"><i class="nav-icon fas fa-user"></i></a>
                            </td>
                            {{-- <td>
