...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Liste des réclamations pour les étudiants</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <td class="text-right">
                                ...
                                <a href="{{ url('edit-reclamation/'.$reclam->idReclamation) }}" class="btn btn-link btn-info btn-just-icon edit btn-sm"><i class="fas fa-eye"></i></a>
                            </td>
                            </tr>
