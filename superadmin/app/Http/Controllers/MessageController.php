...
class MessageController extends Controller
{
    ...
    public function replayMessage($idUser, $nameUser, $roleUser, $objetUser)
    {
        $idAdmin   = Auth::user()->id;
        $IDUSER    = $idUser;
        $NAMEUSER  = $nameUser;
        ...
        return view('message.replay', ['IDUSER' => $IDUSER, 'NAMEUSER' => $NAMEUSER, 'ROLEUSER' => $ROLEUSER, 'OBJETUSER' => $OBJETUSER]);
    }
