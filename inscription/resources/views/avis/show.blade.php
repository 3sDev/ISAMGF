...
@section('title', 'Détails avis enseignants')
 @section('contentPage')
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Détails Avis Enseignants</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="{{ url('avis') }}">Liste des avis enseignants</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="card card-widget">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <img src={{ asset('https://smartschools.tn/university/public/upload/avis/images/'.$avisElement->image) }} class="img-fluid" >
                                  ...
                                  <br>
                                  @if ($avisElement->fichier != 'Null')
                                  <iframe
                                  src={{ asset('https://smartschools.tn/university/public/upload/avis/files/'.$avisElement->fichier )}}
                                  width="100%"
                                  height="678">
                                  </iframe>
                                  @endif
