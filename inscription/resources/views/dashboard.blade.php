            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  ...
                  <p>Service Scolarité</p>
                </div>
                <div class="icon">
                  <i class="ion ion-easel"></i>
                </div>
                <a href="{{ url('demandepersonnel') }}" class="small-box-footer">Accéder <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  ...
                  <p>Services Enseignants </p>
                </div>
                <div class="icon">
                  <i class="ion ion-briefcase"></i>
                </div>
                <a href="{{ url('reclamations') }}" class="small-box-footer">Accéder <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  ...
                  <p>Services Personnels</p>
                </div>
                <div class="icon">
                  <i class="ion ion-person"></i>
                </div>
                <a href="#" class="small-box-footer">Accéder <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
