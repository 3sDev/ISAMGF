                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <td class="text-right">
                                <a href="{{ url('show-admins/'.$adminElement->id) }}" class="btn btn-link btn-info btn-just-icon like"><i class="nav-icon fas fa-eye"></i></a>
                                <a href="{{ url('admins/'.$adminElement->id.'/edit') }}" class="btn btn-link btn-warning btn-just-icon edit"><i class="fas fa-pencil-alt"></i></a>
                            </td>
                            <td>
