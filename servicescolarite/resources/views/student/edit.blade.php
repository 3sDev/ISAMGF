        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('update-student/'.$profile->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de modifier ces données?')">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label class="labelright">الفوج</label>
                                <select id="classe_id" class="form-control" name="classe_id" required>
                                    <option value="{{ $profile->classe->id }}" selected>{{ $profile->classe->abbreviation }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-5" style="padding-bottom:55px; border-bottom: 2px solid rgb(122, 122, 122)">
                                <form action="{{ url('update-cin2/'.$profile->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Êtes-vous sûr de modifier CIN face 2 ?')">
                                    @csrf
                                    @method('PUT')
                                    <label class="labelright">CIN (Face 2) /  بطاقة التعريف الوطنية الوجه الثاني</label>
                                    <div class="invoice-col">
                                        <center>
                                        <img src={{ asset($upload.'/students/cinFace2/'.$profile->cin_file_2) }} style="width: 60% !important; height: 150px;" class="imgCinFace2">
                                        </center>
                                    </div><br>   
                            ...
                            <div class="col-md-5" style="padding-bottom:55px; border-bottom: 2px solid rgb(122, 122, 122)">
                                <form action="{{ url('update-cin1/'.$profile->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Êtes-vous sûr de modifier CIN face 1 ?')">
                                    @csrf
                                    @method('PUT')
                                    <label class="labelright">CIN (Face 1) /  بطاقة التعريف الوطنية الوجه الأول</label>
                                    <div class="invoice-col">
                                        <center>
                                        <img src={{ asset($upload.'/students/cin/'.$profile->cin_file) }} style="width: 60% !important; height: 150px;" class="imgCinFace1">
                                        </center>
                                    </div><br>
                        ...
                        <div class="row">
                        <div class="col-md-5" style="padding-bottom:55px; border-bottom: 2px solid rgb(122, 122, 122)">
                            <form action="{{ url('update-fiche/'.$profile->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Êtes-vous sûr de modifier fiche d\'inscription ?')">
                                @csrf
                                @method('PUT')
                                <label class="labelright">Reçu de Paiement (inscription.tn) / وصل التسجيل عن بعد</label>
                                <div class="">
                                    <img src={{ asset($upload.'/students/inscription/'.$profile->paiement_file) }} class="imgFiche" >
                                </div>
                        ...
                        <div class="col-md-5" style="padding-bottom:55px; border-bottom: 2px solid rgb(122, 122, 122)">
                            <form action="{{ url('update-photo/'.$profile->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Êtes-vous sûr de modifier photo de profil ?')">
                                @csrf
                                @method('PUT')
                                <div class="text-center">
                                    <img src={{ asset($upload.'/students/'.$profile->profile_image) }} style="width:150px !important; height: 160px;" class="profile-user-img img-fluid img-circle imgPhoto"" >
                                </div>
                    ...
                    <br><br>
                    <form action="{{ url('update-passwordStudent/'.$profile->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Êtes-vous sûr de modifier le mot de passe ?')">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                                {{-- <label class="labelright">كلمة السر القديمة</label>
                                <input type="password" id="myInput" name="password" value="" class="form-control" required>
                                <br>
                                <input type="checkbox" style="float: right" onclick="myFunction()"><span class="labelright">إظهار كلمة السر</span>
                                <br><br> --}}
                                <label class="labelright">كلمة السر الجديدة</label>
                                <input type="text" id="new_password" name="new_password"class="form-control" required style="direction: ltr"><br>
                                <label class="labelright">تأكيد كلمة السر الجديدة</label>
                                <input type="text" id="confirm_password" name="confirm_password" class="form-control" required style="direction: ltr"><br>
