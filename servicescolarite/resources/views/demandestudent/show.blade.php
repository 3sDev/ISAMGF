            ...
            <div class="card">
                ...
                <div class="invoice-body">
                    @foreach ($demandestudents as $demand)
                        @if ($demand->sous_type == 'شهادة نجاح' || $demand->sous_type == 'شهادة ترسيم' || $demand->sous_type == 'كشف اعداد' || $demand->sous_type == 'شهادة حضور')
                            <div class="row">
                                <div class="salima">
                                    {{-- <img src="{{ URL::asset($upload'./salima.jpg') }}" width="100%" alt=""> --}}
                                    <img src="{{ URL::asset('/upload/salima.jpg') }}" class="">
                                </div>
                            </div>
                        @endif

                        @if ($demand->sous_type == 'اصلاح وثيقة ادارية')
                          <!-- partial -->
                                ...
                                <div class="panel panel-info">
                                  ...
                                  <div class="panel-body">
                                      ...
                                      <div class=" col-md-9 col-lg-9 "> 
                                        <table class="table table-user-information text-right">
                                          <tbody>
                                            ...
                                            <tr>
                                              <td><b>{{ $demand->type_document }}</b></td>
                                              <td>الوثيقة المراد إصلاحها</td>
                                            </tr>
                                            <tr>
                                              <td><b>{{ $demand->correction_faute }}</b></td>
                                    ...
                                    <div class="panel-footer">
                                      <a href="{{ asset($upload.'/demandesStudents/documentFausse/'.$demand->document_fausse) }}" target="_blank" class="btn btn-primary">النسخة الأصلية من الوثيقة المراد إصلاحها</a>
                        ...
                        @if ($demand->sous_type == 'نظير من وثيقة ادارية')
                          <!-- partial -->
                          <div class="container" style="margin-top: 5%; margin-left: 10%;">
                              <div class="row">
                                <div class="col-md-8" >
                                  <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <div class="panel-footer">
                                        <a href="{{ asset($upload.'/demandesStudents/attestationPerdue/'.$demand->attestation_perdue) }}" target="_blank" class="btn btn-primary"> الوثيقة المصاحبة / شهادة ضياع</a>
