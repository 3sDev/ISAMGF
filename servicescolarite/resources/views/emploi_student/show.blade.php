    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ url('emploi') }}">Liste des emploi de temps des Groupes</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="card card-widget">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">   
                                    <img class="emploiTemps" src={{ asset($upload.'/emploi-student-file/'.$emploiElement->fichier) }} alt="Emploi"/>
