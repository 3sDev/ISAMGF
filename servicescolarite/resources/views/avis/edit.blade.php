        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ url('update-avis/'.$avisElement->id) }}" onsubmit="return confirm('Êtes-vous sûr de modifier ces données?')" enctype="multipart/form-data">
                  ...
                  {{-- @method('PUT') --}}
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <label for="">Liste des classes</label>
                          ...
                          <div class="col-md-6" style="display:none;">
                            ...
                            <select name="type" class="form-control" >
                                <option value="Scolarité" selected>Scolarité</option>
