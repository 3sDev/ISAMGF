            ...
            <div class="card">
                ...
                <div class="card-body">
                  @foreach ($classResult as $classItem)
                        <center><h5><b>Classe :</b> {{ $classItem->abbreviation }}</h5>
                    ...
                    <form action="{{ url('attendances') }}" method="POST">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td align="center">{{ $absElement->id }}</td>
                            ...
                            <td>{{ $absElement->attendance_seance_debut }}</td>
                            <td>{{ $absElement->attendance_seance_fin }}</td>
                            <td>
