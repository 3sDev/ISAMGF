...
use App\Http\Controllers\PostSignalStudentController;
use App\Http\Controllers\RoomBlockStudentController;
...
Route::put('deleteMsgByIdMsgAndStudent/{id}/{student}', [RoomController::class, 'deleteMessageStudent']);
Route::put('archiveRoomStudent/{id}/{student}', [RoomController::class, 'archiveRoomStudent']);
Route::put('restoreArchiveRoomStudent/{id}/{student}', [RoomController::class, 'restoreArchiveRoomStudent']);
Route::put('deleteRoomStudent/{id}/{student}', [RoomController::class, 'deleteRoomStudent']);
...
//Signal Post (Forum) Students Routes 
Route::get('getFlaggetPostByIdStudent/{id}', [PostSignalStudentController::class, 'index']);
Route::get('getAllFlaggedPosts',   [PostSignalStudentController::class, 'getAllFlaggedPosts ']);
Route::get('getFlaggedPostsWithIdStudent/{id}',   [PostSignalStudentController::class, 'getFlaggedPostsWithIdStudent']);
Route::post('addFlaggedPost',       [PostSignalStudentController::class, 'store']);
Route::put('updateFlaggedPostById/{id}', [PostSignalStudentController::class, 'update']);
Route::delete('deleteFlaggedPost/{id}', [PostSignalStudentController::class, 'destroy']);

//Blocked Students Routes 
Route::get('getAllblockedByIdBlocker/{id}', [RoomBlockStudentController::class, 'index']);
Route::post('addNewBlocked',       [RoomBlockStudentController::class, 'store']);
Route::delete('deleteBlockStudent/{idBlock}', [RoomBlockStudentController::class, 'destroy']);
