        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('formations') }}" method="POST" onsubmit="return confirm('Êtes-vous sûr d\'ajouter cet element?')" enctype="multipart/form-data">
                        ...
                        {{-- @method('PUT') --}}
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nom_formation" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="date_fin" value="" class="form-control">
                                </div>
                            </div>
                            <br><br>
                            <div class="mb-3">
