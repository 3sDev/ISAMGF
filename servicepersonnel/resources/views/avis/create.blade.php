        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('avis') }}" method="POST" onsubmit="return confirm('Êtes-vous sûr d\'ajouter cet avis ?')" enctype="multipart/form-data">
                        ...
                        {{-- @method('PUT') --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="type" value="Personnel" class="form-control" readonly>
                                </div>
                            </div>
                            <br><hr><br>
                            <div class="row">
