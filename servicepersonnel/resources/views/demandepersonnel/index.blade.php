...
{{-- 
                            ...
                            <td>{{ $demand->personnel->poste }}</td>
                            <td>{{ date('Y-m-d | H:i', strtotime($demand->created_at)) }}</td>
                            {{-- <td>{{ strtotime($demand->created_at).date('Y-m-d') }}</td> --}}
                            
                            <td class="text-center">
                                <a href="{{ url('edit-demandepersonnel/'.$demand->id) }}" class="btn btn-link btn-success btn-just-icon edit btn-sm"><i class="nav-icon fas fa-edit"></i></a>
