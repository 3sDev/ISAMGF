            ...
            <div class="row">
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                  ...
                  <a href="{{ url('demandepersonnel') }}" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- ./col -->
              <div class="col-lg-3 col-6">
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                  ...
                  <a href="{{ url('personnels') }}" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- ./col -->
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                  <div class="inner">
                    <h3>{{ $allAttendances }}</h3>
    
                    <p>Tous les absences</p>
                  </div>
                  <div class="icon">
