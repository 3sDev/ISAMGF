...
class PersonnelController extends Controller
{
    ...
    public function create()
    {
        ...
        $response2 = Http::get($this->getUrlServer().'/AllPostePersonnelsCategorie');
        $categories = json_decode($response2); 

        $response3 = Http::get($this->getUrlServer().'/AllPostePersonnelsGrade');
        $grades = json_decode($response3); 

        return view('personnel.create', ['fonctions' => $fonctions, 'categories' => $categories, 'grades' => $grades]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('personnel.edit', ['profiles' => $profiles, 'fonctions' => $fonctions, 'categories' => $categories, 'grades' => $grades]);
    }
