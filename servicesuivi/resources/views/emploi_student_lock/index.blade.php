...
<div class="row mb-2">
    <div class="col-sm-6">
    <h1 class="m-0">Emploi de temps étudiants</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{ url('dashboards') }}">Dashboard</a></li>
        <li class="breadcrumb-item active">Emploi de temps étudiants</li>
    </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
</div><!-- /.container-fluid -->
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ url('emplois/create') }}" class="btn btn-primary float-right">Ajouter</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="filtr-item">
                                    <a href={{ asset('https://smartschools.tn/university/public/upload/emploi-student-file/'.$emploi->fichier) }} target="_blank" data-toggle="lightbox" data-title="sample 4 - red">
                                    <img class="emploiTemps" src={{ asset('https://smartschools.tn/university/public/upload/emploi-student-file/'.$emploi->fichier) }} alt="Emploi"/>
                                    </a>
                                </div>
                            </td>
