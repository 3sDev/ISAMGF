      ...
      <div class="col-md-3">
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              ...
              <ul class="list-group list-group-unbordered mb-3">
                ...
                <li class="list-group-item">
                  <b>Téléphone</b> <a class="float-right">{{ $profile->profile_teacher->phone }}</a>
                </li>
              </ul>
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <p class="text-muted">{{ $profile->profile_teacher->genre }}</p>
            <hr>
            <strong><i class="fas fa-book mr-1"></i> Date de naissance</strong>
            <p class="text-muted">
              {{ $profile->profile_teacher->ddn }}
            </p>
            <hr>
            <strong><i class="fas fa-map-marker-alt mr-1"></i> Location</strong>
            <p class="text-muted">{{ $profile->profile_teacher->rue.", ".$profile->profile_teacher->gov.", ".$profile->profile_teacher->codepostal  }}</p>
          </div>
          <!-- /.card-body -->
        </div>
        <!-- /.card -->
              ...
              <div class="active tab-pane" id="demande">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td class="text-right">
                        <a href="{{ url('edit-demandeteacher/'.$demand->id) }}" class="btn btn-link btn-success btn-just-icon edit"><i class="fas fa-pencil-alt"></i></a>
                    </td>
                    <td class="text-right">
                        <a href="{{ url('show-demandeteacher/'.$demand->id) }}" class="btn btn-link btn-info btn-just-icon edit"><i class="nav-icon fas fa-eye"></i></a>
                    </td>
                    <td>
                ...
                <table id="example3" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($reclamationteacher as $teacher)
                      @foreach ($teacher->reclamations as $reclam)
                      <tr>
                        <td>{{ $reclam->id }}</td>
