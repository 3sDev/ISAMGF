...
class AvisController extends Controller
{
    ...
    {
        $response = Http::get($this->getUrlServer().'/avis-type/scolarité');
    ...
    public function create()
    {
        ...
        return view('avis.create', ['classes' => $classes]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::post($this->getUrlServer().'/avis-classe', [
    ...
    {
        $response = Http::get($this->getUrlServer().'/avis-classes/'.$id);
        $avis = json_decode($response);  
