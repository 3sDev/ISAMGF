...
class EmploiTempsFileStudentController extends Controller
{
    use MyTrait;
    use ConvertBase64;
    /**
    ...
    public function store(Request $request)
    {
        ...
        error_log('Emploi Groupe File--------------------------------------------------------------------------'.$response);
        return redirect('/emplois')->with('message', 'Emploi de Groupe est ajouté avec succés');
    }
