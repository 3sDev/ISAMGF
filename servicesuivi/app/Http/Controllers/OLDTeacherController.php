...
class TeacherController extends Controller
{
    ...
    {   
        ...
        $resultLundi = $this->analyseEmploi($teacherEmploiLundi);
        ...
        $resultMardi = $this->analyseEmploi($teacherEmploiMardi);
        ...
        $resultMercredi = $this->analyseEmploi($teacherEmploiMercredi);
        ...
        $resultJeudi = $this->analyseEmploi($teacherEmploiJeudi);
        ...
        $resultVendredi = $this->analyseEmploi($teacherEmploiVendredi);
        ...
        $resultSamedi = $this->analyseEmploi($teacherEmploiSamedi);
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::post($this->getUrlServer().'/inscription', [
