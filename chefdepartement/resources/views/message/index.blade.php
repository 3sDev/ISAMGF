            ...
            <ul class="nav nav-pills flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#mes" data-toggle="tab">
                  <i class="far fa-paper-plane"></i> Messages envoyés
                </a>
              </li>
              <li class="nav-item">
        ...
        <div class="card card-primary card-outline">
          ...
          <div class="card-body p-0">
            ...
            <div class="tab-content">
                ...
                <table id="example3" class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="notView"><span class="textable">{{ $msgservice->nameSender }}</span></td>
                        
                        <td class="notView">{{ date('Y-m-d | H:i', strtotime($msgservice->created_at)) }}</td>
                        <td class="text-center">
                          <a href="{{ url('show-message-receive/'.$msgservice->id.'/'.$msgservice->idMessageUser) }}" class="btn btn-link btn-info btn-just-icon like btn-sm"><i class="nav-icon fas fa-eye"></i></a>
                          {{-- <a href="{{ url('message/'.$msg->id.'/edit') }}" class="btn btn-link btn-warning btn-just-icon edit"><i class="fas fa-pencil-alt"></i></a> --}}
                        </td>
                        <td>
                          <form action="{{ url('corbeil-message/'.$msgservice->idMessageUser) }}" onsubmit="return confirm('Confirmation!')">
                            @csrf
                            @method('DELETE')
                      ...
                      <tr>
                        ...
                        <td class="view"><span class="textable">{{ $msgservice->nameSender }}</span></td>
              ...
              <!-- /.mail-box-messages Services(messages envoyés) -->
              <div class="tab-pane" id="mes">
                  ...
                  <table id="example4" class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="{{ url('show-message-send/'.$msgRS->id) }}" class="btn btn-link btn-info btn-just-icon like btn-sm"><i class="nav-icon fas fa-eye"></i></a>
                        </td>
                        <td>
                          <form action="{{ url('corbeil-message/'.$msgRS->idMessageUser) }}" onsubmit="return confirm('Confirmation!')">
                            <button type="submit" class="btn btn-link btn-danger btn-just-icon remove btn-sm"><i class="fas fa-trash"></i></button>
                          </form>
                        </td>
                      </tr>
                ...
                <!-- /.mail-box-messages Services Corbeil -->
                <div class="tab-pane" id="corbeille">
                  ...
                  <table id="example1" class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><span class="textable">{{ $msgs->objet }}</span></td>
                          <td><span class="textable">{{ $msgs->message }}</span></td>
                          ...
                          <td>
                            <form action="{{ url('restaurer-message/'.$msgs->idMessageUser) }}" onsubmit="return confirm('Restaurer ce message!')">
                              <button type="submit" class="btn btn-link btn-warning btn-just-icon remove btn-sm"><i class="fas fa-undo"></i></button>
                            </form>
                          </td>
                          <td>
                            <form action="{{ url('delete-message/'.$msgs->idMessageUser) }}" onsubmit="return confirm('Supprimer définitivement')">
