                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                      <div class="col-lg-12" style="text-align:left !important;">      
                                            <div class="form-group">
                                              <h3 style="color: orangered; font-weight:bold; text-align:center">{{$classe->abbreviation}} <span style="color: rgb(117, 57, 36); font-weight: 400; font-size: 29px">(Semestre {{ $mySemestre }} )</span></h3><br>
                                              <div>
                                                <div>
                                      ...
                                      <div class="col-lg-12" style="text-align:left !important;">
                                        <div class="form-group">
                                          ...
                                          @foreach ($emploiGroupe as $emploiFile)
                                            <img src={{ asset($upload.'/emploi-student-file/'.$emploiFile->fichier) }} width="100%" alt="">
                                          @endforeach
