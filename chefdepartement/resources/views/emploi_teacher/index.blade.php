                        ...
                        <tbody>
                            ...
                            <td class="text-center">
                                <div class="filtr-item">
                                    <a href={{ asset($upload.'/emploi-teacher-file/'.$emploi->fichier) }} target="_blank" data-toggle="lightbox" data-title="sample 4 - red">
                                    <img class="emploiTemps" src={{ asset($upload.'/emploi-teacher-file/'.$emploi->fichier) }} alt="Emploi"/>
                                    </a>
                                </div>
                            </td>
                            ...
                            <td>{{ date('Y-m-d | H:i', strtotime($emploi->updated_at)) }}</td>
