...
Route::get('teachers-schedule/{id}/{semestre}', [TeacherController::class, 'scheduleteacherDetails']);
...
Route::delete('deleteSeanceSemestre/{id}', [EmploiTeacherController::class, 'destroySeanceFromSemestre']);

//Classe Emploi+Classe
Route::get('scheduleclasse',     [ClasseController::class, 'index']);
Route::get('emploi-classe/{id}', [ClasseController::class, 'getScheduleFromClasse']);
Route::get('emploi-classe-semestre/{id}/{semestre}', [ClasseController::class, 'getScheduleFromClasseBySemestre']);
Route::get('createClasse',       [ClasseController::class, 'create']);
Route::post('classes',           [ClasseController::class, 'store']);
Route::get('edit-groupe/{id}',   [ClasseController::class, 'edit']);
Route::get('update-groupe/{id}', [ClasseController::class, 'update']);
...
Route::get('disponibiliteSallesSeancesSemestre/{debut}/{fin}/{day}/{type_seance}/{semestre}', [TeacherController::class, 'disponibiliteSallesSeancesSemestre']);
