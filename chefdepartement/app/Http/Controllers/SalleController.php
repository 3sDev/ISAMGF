...
{ 
    ...
    public function emploiSalleSemestre($id, $semestre)
    {
        $inserted = array( 'vide' );
        $mySemestre = $semestre;
        ...
        if ($mySemestre == "1") {
            $response2 = Http::get($this->getUrlServer().'/all-salles-statut-semestre1/'.$id);
            $salleseance = json_decode($response2);
        } else {
            $response2 = Http::get($this->getUrlServer().'/all-salles-statut-semestre2/'.$id);
            $salleseance = json_decode($response2);
        }

        /************************************************************************************** */
        $responseLundi = Http::get($this->getUrlServer().'/emploi-salle-day-semestre/'.$id.'/Lundi/'.$semestre);
        $salleEmploiLundi = json_decode($responseLundi);
        $resultLundi = $salleEmploiLundi;
        //array_splice( $resultLundi, 3, 0, $inserted );

        $responseMardi = Http::get($this->getUrlServer().'/emploi-salle-day-semestre/'.$id.'/Mardi/'.$semestre);
        $salleEmploiMardi = json_decode($responseMardi);
        $resultMardi = $salleEmploiMardi;
        //array_splice( $resultMardi, 3, 0, $inserted );

        $responseMercredi = Http::get($this->getUrlServer().'/emploi-salle-day-semestre/'.$id.'/Mercredi/'.$semestre);
        $salleEmploiMercredi = json_decode($responseMercredi);
        $resultMercredi = $salleEmploiMercredi;
        //array_splice( $resultMercredi, 3, 0, $inserted );

        $responseJeudi = Http::get($this->getUrlServer().'/emploi-salle-day-semestre/'.$id.'/Jeudi/'.$semestre);
        $salleEmploiJeudi = json_decode($responseJeudi);
        $resultJeudi = $salleEmploiJeudi;
        //array_splice( $resultJeudi, 3, 0, $inserted );

        $responseVendredi = Http::get($this->getUrlServer().'/emploi-salle-day-semestre/'.$id.'/Vendredi/'.$semestre);
        $salleEmploiVendredi = json_decode($responseVendredi);
        $resultVendredi = $salleEmploiVendredi;
        //array_splice( $resultVendredi, 3, 0, $inserted );

        $responseSamedi = Http::get($this->getUrlServer().'/emploi-salle-day-semestre/'.$id.'/Samedi/'.$semestre);
        $salleEmploiSamedi = json_decode($responseSamedi);
        $resultSamedi = $salleEmploiSamedi;
        //array_splice( $resultSamedi, 3, 0, $inserted );

        return view('salle.emploi-salle', ['salles' => $salles, 'salleseance' => $salleseance, 'salleName' => $salleName,
        'salleEmploiLundi' => $resultLundi, 'salleEmploiMardi' => $resultMardi, 'salleEmploiMercredi' => $resultMercredi, 
        'salleEmploiJeudi' => $resultJeudi, 'salleEmploiVendredi' => $resultVendredi, 'salleEmploiSamedi' => $resultSamedi,
        'mySemestre' => $mySemestre]);
    }
    ...
    {
        $mySemestre = $request->date_disponible;
        ...
        if ($semestre == "1") {
        $response1 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/1');
        $Salle1 = json_decode($response1);

        $response2 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/2');
        $Salle2 = json_decode($response2);

        $response3 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/3');
        $Salle3 = json_decode($response3);

        $response4 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/4');
        $Salle4 = json_decode($response4);

        $response5 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/5');
        $Salle5 = json_decode($response5);

        $response6 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/6');
        $Salle6 = json_decode($response6);

        $response7 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/7');
        $Salle7 = json_decode($response7);

        $response8 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/8');
        $Salle8 = json_decode($response8);

        $response9 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/9');
        $Salle9 = json_decode($response9);

        $response10 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/10');
        $Salle10 = json_decode($response10);

        $response11 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/11');
        $Salle11 = json_decode($response11);

        $response12 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/12');
        $Salle12 = json_decode($response12);

        $response13 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/13');
        $Salle13 = json_decode($response13);

        $response14 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/14');
        $Salle14 = json_decode($response14);

        $response15 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/15');
        $Salle15 = json_decode($response15);

        $response16 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/16');
        $Salle16 = json_decode($response16);

        $response17 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/17');
        $Salle17 = json_decode($response17);

        $response18 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/18');
        $Salle18 = json_decode($response18);

        $response19 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/19');
        $Salle19 = json_decode($response19);

        $response20 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/20');
        $Salle20 = json_decode($response20);

        $response21 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/21');
        $Salle21 = json_decode($response21);

        $response22 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/22');
        $Salle22 = json_decode($response22);

        $response23 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/23');
        $Salle23 = json_decode($response23);

        $response24 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/24');
        $Salle24 = json_decode($response24);

        $response25 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreOne/'.$seanceAbs.'/25');
        $Salle25 = json_decode($response25);
        } 
        else 
        {
        $response1 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/1');
        $Salle1 = json_decode($response1);

        $response2 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/2');
        $Salle2 = json_decode($response2);

        $response3 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/3');
        $Salle3 = json_decode($response3);

        $response4 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/4');
        $Salle4 = json_decode($response4);

        $response5 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/5');
        $Salle5 = json_decode($response5);

        $response6 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/6');
        $Salle6 = json_decode($response6);

        $response7 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/7');
        $Salle7 = json_decode($response7);

        $response8 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/8');
        $Salle8 = json_decode($response8);

        $response9 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/9');
        $Salle9 = json_decode($response9);

        $response10 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/10');
        $Salle10 = json_decode($response10);

        $response11 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/11');
        $Salle11 = json_decode($response11);

        $response12 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/12');
        $Salle12 = json_decode($response12);

        $response13 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/13');
        $Salle13 = json_decode($response13);

        $response14 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/14');
        $Salle14 = json_decode($response14);

        $response15 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/15');
        $Salle15 = json_decode($response15);

        $response16 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/16');
        $Salle16 = json_decode($response16);

        $response17 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/17');
        $Salle17 = json_decode($response17);

        $response18 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/18');
        $Salle18 = json_decode($response18);

        $response19 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/19');
        $Salle19 = json_decode($response19);

        $response20 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/20');
        $Salle20 = json_decode($response20);

        $response21 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/21');
        $Salle21 = json_decode($response21);

        $response22 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/22');
        $Salle22 = json_decode($response22);

        $response23 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/23');
        $Salle23 = json_decode($response23);

        $response24 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/24');
        $Salle24 = json_decode($response24);

        $response25 = Http::get($this->getUrlServer().'/disponibiliteAllSallesByDayAndIdSalleSemestreTwo/'.$seanceAbs.'/25');
        $Salle25 = json_decode($response25);
        }
        ...
        'Salle24' => $Salle24, 'Salle25' => $Salle25, 'dateAbs' => $dateAbs, 'seanceAbs' => $seanceAbs, 
        'rattrapages' => $rattrapages, 'semestre' => $semestre]);
    }
