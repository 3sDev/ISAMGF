...
class TeacherController extends Controller
{
    ...
    public function scheduleteacherDetails($id, $semestre)
    {   
        $mySemestre = $semestre;
        $inserted = array( 'vide' );
        
        $response = Http::get($this->getUrlServer().'/getVoeuxByIdTeacherAndSemestre/'.$id.'/'.$semestre);
        $voeuxTeachers = json_decode($response); 

        $response2 = Http::get($this->getUrlServer().'/getEmploiTempsTeacherBySemestre/'.$id.'/'.$semestre);
        ...
        $response7 = Http::get($this->getUrlServer().'/emploi-teacher-semestre/'.$id.'/'.$semestre);
        $teacherEmploi = json_decode($response7);  
        /*********************************************************************************** */
        $responseLundi = Http::get($this->getUrlServer().'/emploi-teacher-day-semestre/'.$id.'/Lundi/'.$semestre);
        ...
        $responseMardi = Http::get($this->getUrlServer().'/emploi-teacher-day-semestre/'.$id.'/Mardi/'.$semestre);
        ...
        $responseMercredi = Http::get($this->getUrlServer().'/emploi-teacher-day-semestre/'.$id.'/Mercredi/'.$semestre);
        ...
        $responseJeudi = Http::get($this->getUrlServer().'/emploi-teacher-day-semestre/'.$id.'/Jeudi/'.$semestre);
        ...
        $responseVendredi = Http::get($this->getUrlServer().'/emploi-teacher-day-semestre/'.$id.'/Vendredi/'.$semestre);
        ...
        $responseSamedi = Http::get($this->getUrlServer().'/emploi-teacher-day-semestre/'.$id.'/Samedi/'.$semestre);
        ...
        return view('teacher.scheduledetails', ['teachers' => $teachers, 'matieres' => $matieres,
                                                ...
                                                'emploiTeacher' => $emploiTeacher, 'mySemestre' => $mySemestre]);
    }
    ...
    public function disponibiliteSallesSeancesSemestre($debut, $fin, $day, $type_seance, $semestre)
    {
        $response = Http::get($this->getUrlServer().'/tous-salles-disponible-seances-semestre/'.$debut.'/'.$fin.'/'.$day.'/'.$type_seance.'/'.$semestre);
        $result = json_decode($response);
        return response()->json($result);
    }
