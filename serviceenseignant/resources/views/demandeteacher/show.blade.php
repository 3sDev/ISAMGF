    ...
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <span>Le Directeur de l’Institut Supérieur d'arts et métiers de Gafsa atteste que</span><br><br>
                                            @else
                                                <span>Le secrétaire général de l’Institut Supérieur d'arts et métiers de Gafsa atteste que</span><br><br>
                                            @endif                                            <span>Mr (me) : </span> <label>{{ $demand->teacher->nom.' '.$demand->teacher->prenom  }}</label><br>
                                            <span>Né(e) le : </span> <label>{{ $demand->teacher->ddn }}</label> à <label>{{ $demand->teacher->gov }}</label><br>

                                            @if ($demand->teacher->nationnalite == 'تونسية' || $demand->teacher->nationnalite == 'Tunisienne')
                                            ...
                                            <span>Identifiant unique : </span> <label>{{ $demand->teacher->matricule }}</label><br>
                                            <span>Carte d'Identité Nationale : </span> <label>{{ $demand->teacher->cin }}</label><br>
                                            <span>Exerce à l’Institut Supérieur d'arts et métiers de Gafsa en qualité de :</span>
                                            <center>
                                                <h4>{{ explode("/", $demand->teacher->poste)[0] }}</h4>
                                            </center>
                                            ...
                                            <div class="signature">
                                                <center>
                                                    ...
                                                    <span>{{ $variables[0]->directeur_fr }}</span><br><br><br><br><br><br><br><br><br><br><br>
                                                </center>
                                            </div>
                            ...
                            <table width="100%">
                                ...
                                <tr align="center">
                                    <td>
                                        ...
                                        <SPAN class="headerTextAr">المعهد العالي للفنون والحرف بقفصة</SPAN><BR>
                                    ...
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        ...
                                        <div class="signatureAr">
                                            <center>
                                                ...
                                                @if ($signature == 'Directeur')
                                                    <span>المدير</span><br>
                                                    <span>{{ $variables[0]->directeur_ar }}</span><br><br><br><br><br>
                                                @else
                                                    <span>الكاتب العام</span><br>
                                                    <span>{{ $variables[0]->secretaire_ar }}</span><br><br><br><br><br>
                                                @endif
                                            </center>
                                        </div>
                                    ...
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        <table style="width: 100%; direction: rtl">
                                            ...
                                            <tr>
                                                ...
                                                <td width="64%"><label>{{ $demand->teacher->prenom_ar }}</label></td>
                                            </tr>
                                            <tr>
                                                <td width="36%"><span>اللقب</span><span style="float: left; margin-left: 20%;">:</span> </td>
                                                <td width="64%"><label>{{ $demand->teacher->nom_ar }}</label></td>
                                            </tr>
                                            {{-- <tr>
                                                <td><span>رتبته أو صنفه</span><span style="float: left; margin-left: 20%;">:</span> </td>
                                                <td><label>{{ $demand->teacher->grade }}</label></td>
                                            </tr> --}}
                                            <tr>
                                                <td><span>خطته الوظيفية</span><span style="float: left; margin-left: 20%;">:</span> </td>
                                                <td><label>{{ explode("/", $demand->teacher->type_enseignant)[1] }}</label></td>
                            ...
                            <table width="100%">
                                ...
                                <tr align="center">
                                    <td>
                                        ...
                                        <SPAN class="headerTextAr">  للفنون والحرف بقفصة </SPAN><BR>
                                        <SPAN class="headerTextAr">   </SPAN><BR>
                                    </td>
                                    <td></td>
                                    <td>
                                        <SPAN class="headerText1Ar">الجمهورية التونسية</SPAN><BR>
                                    ...
                                    <div class="col-xs-11 labelAr" style="text-align:right !important;">
                                        <table style="width: 100%; direction: rtl">
                                            ...
                                            <tr>
                                                ...
                                                <td width="64%"><label>{{ $demand->teacher->ddn.'-'.$demand->teacher->gov_ar }}</label></td>
                                            </tr>
                                            {{-- <tr>
                                                <td><span>رتبته أو صنفه</span><span style="float: left; margin-left: 20%;">:</span> </td>
                                                <td><label>{{ $demand->teacher->grade }}</label></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="64%">
                                                    @if ($demand->teacher->date_recrutement)
                                                        <label>{{ $demand->teacher->date_recrutement }}</label>
                                                    @else
                                                        <label>..........................</label>
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="64%"><label>{{ $demand->teacher->grade }}</label></td>
                                            </tr>
                                            <tr>
            ...
            @endif
                    ...
                    @php
                        $fileName= $demand->teacher->nom.$demand->teacher->prenom.$demand->type ;
                    @endphp 
