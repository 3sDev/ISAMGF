                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @endif
                            <td class="text-right">
                                <a href="{{ url('show-agenda/'.$agd->id) }}" class="btn btn-link btn-info btn-just-icon like"><i class="nav-icon fas fa-eye"></i></a>
                                <a href="{{ url('agenda/'.$agd->id.'/edit') }}" class="btn btn-link btn-warning btn-just-icon edit"><i class="fas fa-pencil-alt"></i></a>
                            </td>
                            <td>
