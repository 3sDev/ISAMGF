            ...
            <div class="row">
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                  <div class="inner">
                    <h3>{{ $demandeEnCours }}/{{ $allDemands }}</h3>
                  ...
                  <a href="{{ url('demandeteacher') }}" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- ./col -->
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                  <div class="inner">
                    <h3>{{ $reclamationEnCours }}/{{ $allReclamations }}</h3>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                  ...
                  <a href="{{ url('teachers') }}" class="small-box-footer">Voir Plus <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- ./col -->
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                  <div class="inner">
                    <h3>{{ $allRattrapages }}</h3>
    
                    <p>Rattrapages enseignants</p>
                  </div>
                  <div class="icon">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-gradient-maroon">
                <div class="inner">
                  <h3>{{ $teacherContractuel }}</h3>
  
                  <p>Enseignants Contractuels</p>
                </div>
                <div class="icon">
                  <i class="ion ion-document"></i>
                </div>
