                    ...
                    <form action="{{ url('update-teacher/'.$profile->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Êtes-vous sûr de modifier cette donnée?')">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="gov_ar" class="form-control" name="gov_ar">
                                    <option value="{{ $profile->gov_ar }}">{{ $profile->gov_ar }}</option>
                                    <option value="" disabled>------------------------</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="specialite_ens" id="specialite_ens" class="form-control" required>
                                    <option value="{{ $profile->specialite_ens }}" selected>{{ $profile->specialite_ens }}</option>
                                    @foreach ($specialites as $spe)
                                    <option value="{{ $spe->label }}">{{ $spe->label }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
