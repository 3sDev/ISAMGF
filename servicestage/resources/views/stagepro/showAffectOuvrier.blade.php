        ...
        <div class="col-md-12">
            <div class="card" id="invoicepdf" style="margin-left: -3% !important; margin-top: -3% !important;">
                ...
                <div class="invoice-body">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-12 content">
                                    ...
                                    <span>est désigné(e) pour effectuer un stage : <b>Ouvrier</b> dans votre établissement du</span><br>
                    ...
                    @php
                        $mydate = date('d/m/Y');
                        $fileName= $demand->student->nom.$demand->student->prenom.'AffectationStage_Ouvrier' ;
                    @endphp 
