                ...
                <div class="invoice-body">
                    ...
                    <div class="col-xs-12" style="margin-top: 4%">
                        @if ($demand->sous_type == 'اقتراح مشروع تخرج في شركة')
                            <center class="titreDemande"><h4>A Monsieur le Directeur de : <b>{{ $demand->nom_societe_pfe }}</b></h4></center>
                        @else
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-12 content">
                                    ...
                                    <span>En vous remerciant de votre bienveillante collaboration, veuillez agréer, Monsieur le Directeur, l’expression de mes meilleures salutations.</span><br>
                                    <br>
