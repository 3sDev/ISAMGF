...
class DownloadController extends Controller
{
    ...
    {
        $response = Http::put($this->getUrlServer().'/update-download/'.$id, [
            'titre'         => $request->input('titre'),
            'description'   => $request->input('description'),
            'categorie'     => $request->input('categorie'),
        ]);
    ...
    public function updateFileDownload(Request $request, $id)
    {
        ...
        $response = Http::put($this->getUrlServer().'/update-fileDownload/'.$id, [
            'fichier'         => $myFile,
    ...
    {
        $response = Http::delete($this->getUrlServer().'/delete-download-stage/'.$id);
